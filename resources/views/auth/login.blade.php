                    ...
                    <div class="card-body">
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image text-center">
                                <img src="{{ asset('asset') }}/dist/img/login-img.png" alt="Login Image" style="max-width: 70%; height: auto;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                        ...
                        <form action="{{ route('login') }}" method="POST" class="user">
                            ...
                            <div class="form-group">
                                <input type="text" name="user_nama" class="form-control form-control-user"
                                    id="user_nama" placeholder="Enter Username" value="{{ old('user_nama') }}" required>
                                @error('user_nama')
